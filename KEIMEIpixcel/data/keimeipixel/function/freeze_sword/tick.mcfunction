...
#charge_10-40
execute as @a[scores={useingtime=0}] at @s if score @s charge_value matches 10..40 run function keimeipixel:freeze_sword/sword_magics/charge_10-40
...
#charge_41-80
execute as @a[scores={useingtime=0}] at @s if score @s charge_value matches 41..80 run function keimeipixel:freeze_sword/sword_magics/charge_41-80
...
#charge_81-140
execute as @a[scores={useingtime=0}] at @s if score @s charge_value matches 81..140 run function keimeipixel:freeze_sword/sword_magics/charge_81-140
...
execute as @e[tag=freeze_sword_ice_marker,type=marker] at @s if score @s effect_timer matches 200.. run fill ~ ~ ~ ~ ~2 ~ minecraft:air replace minecraft:ice
execute as @e[tag=freeze_sword_ice_marker,type=marker,scores={effect_timer=200..}] run kill @s

#overload
execute as @a[scores={useingtime=0}] at @s if score @s charge_value matches 141.. run function keimeipixel:freeze_sword/sword_magics/charge_overload
