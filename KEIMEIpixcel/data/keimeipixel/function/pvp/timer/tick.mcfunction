...
scoreboard players operation #total_min_temp game_timer_tick /= #20 game_timer_tick
scoreboard players operation #total_min_temp game_timer_tick /= #60 game_timer_tick
scoreboard players operation #min game_timer_tick = #total_min_temp game_timer_tick 

scoreboard players operation #total_sec_temp_2 game_timer_tick = #total_sec game_timer_tick
scoreboard players operation #total_sec_temp game_timer_tick %= #1200 game_timer_tick
execute if score #total_sec_temp game_timer_tick >= #0 game_timer_tick run scoreboard players set #sec game_timer_tick 59
...
execute if score #total_sec_temp game_timer_tick >= #0 game_timer_tick run scoreboard players remove #sec game_timer_tick 1
