...
execute as @a[tag=game_player,scores={matching_timer=204..206}] at @s run title @s title [{text:"< スタート >",color:"red",bold:true}]
execute as @a[tag=game_player,scores={matching_timer=204..206}] at @s run function keimeipixel:pvp/timer/3min_timer
...
execute as @a[tag=game_player,scores={matching_timer=223}] at @s run give @a[tag=game_player] iron_sword 1

execute as @a[tag=game_player,scores={matching_timer=220}] at @s run function keimeipixel:pvp/start/reset_matching
execute as @a[tag=game_player,scores={matching_timer=230}] at @s run scoreboard players reset @s matching_timer
