...
execute as @e[tag=fire_circle_marker_new] at @s if entity @e[type=!player,dy=1] run tag @s add fire_circle_marker_gnd 
...
execute as @e[tag=fire_circle_marker_gnd] at @s run function fire_circle:summon_circle
