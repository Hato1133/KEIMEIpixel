...
execute as @e[tag=Sp_Wand_fa,scores={Sp_Wand=11..}] at @s positioned ~ ~-1 ~ as @e[distance=..1.1,type=!#magic:dnt_attack] run damage @s 9 minecraft:generic by @p
...
execute as @a[scores={Ev_Sword_c=85..,Ev_Sword_t=3..}] at @s as @e[distance=0.1..15,type=!#magic:dnt_attack] at @s run particle minecraft:reverse_portal ~ ~5 ~ 0 10 0 0.7 700 force @a
execute as @a[scores={Ev_Sword_c=85..,Ev_Sword_t=3..}] at @s as @e[distance=0.1..15,type=!#magic:dnt_attack] at @s run playsound minecraft:entity.lightning_bolt.impact player @a ~ ~1 ~ 5 1
execute as @a[scores={Ev_Sword_c=85..,Ev_Sword_t=3..}] at @s as @e[distance=0.1..15,type=!#magic:dnt_attack] at @s run damage @s 20 minecraft:generic by @p
execute as @a[scores={Ev_Sword_c=85..,Ev_Sword_t=3..}] at @s unless entity @e[distance=0.1..15,type=!#magic:dnt_attack] run playsound minecraft:block.fire.extinguish player @s ~ ~1 ~ 0.8 2
